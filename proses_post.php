...
if (isset($_POST['delete'])) {
    //mengabil ID post dari parameter URL
    $postID=$__POST['postID'];

    //query untuk menghapus post dari parameter URL
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update'])) {
    ...
    if ($conn->query($queryUpdate) === TRUE) {
        ...
        $_SESSION['notification'] = [
            'type' => 'danger' ,
            'message'=> 'gagal memperbaruhu postingan.'      
        ];
    }
